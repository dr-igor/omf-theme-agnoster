...
set -q color_virtual_env_bg; or set -g color_virtual_env_bg yellow
...
set -q color_vi_mode_default_bg; or set -g color_vi_mode_default_bg green
set -q color_vi_mode_default_str; or set -g color_vi_mode_default_str black
set -q color_vi_mode_insert_bg; or set -g color_vi_mode_insert_bg purple
set -q color_vi_mode_insert_str; or set -g color_vi_mode_insert_str black
set -q color_vi_mode_visual_bg; or set -g color_vi_mode_visual_bg yellow
set -q color_vi_mode_visual_str; or set -g color_vi_mode_visual_str black
...
function prompt_vi_mode_left -d "Display current vi mode"
    # Only show if using vi key bindings
    ...
    switch $fish_bind_mode
        case default
            prompt_segment $color_vi_mode_default_bg $color_vi_mode_default_str N
        case insert
            prompt_segment $color_vi_mode_insert_bg $color_vi_mode_insert_str I
        case visual
            prompt_segment $color_vi_mode_visual_bg $color_vi_mode_visual_str V
        case replace_one replace
            prompt_segment $color_vi_mode_default_bg $color_vi_mode_default_str R
    end
end
